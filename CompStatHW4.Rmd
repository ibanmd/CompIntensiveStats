...
3. If $u1 < \alpha$, (odd case) set $x = 2(floor(5u_2))+5$
...
Out of 100,000 trials, approximately $`r mean(distribution>50000)`$ trials resulted in an outcome where the total value of the claims exceeded $50,000. 
