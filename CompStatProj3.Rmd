...
test_stat <- function(data, treatments){
  return(sum(sum(data[treatments=="A"])^2, 
             sum(data[treatments=="B"])^2, 
             sum(data[treatments=="C"])^2))
}
```
...
The number of test statistics in this set of 800 greater than or equal to 5133 is:
