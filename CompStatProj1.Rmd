...
Testing the first million seeds was done a thousand seeds at a time.  For each group of thousand seeds, the number that passed the test was returned.  Below is a histogram of the number of seeds out of a thousand that passed the test, for each group of thousand from one to one million.  
$\smallskip$
